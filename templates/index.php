    ...
    <nav class="app-header navbar navbar-expand bg-body">
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-md-block"><a href="#" class="nav-link" style="font-weight: bolder; color: black;">Home</a></li>
    ...
    <main class="app-main">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                <li class="breadcrumb-item"><a href="#" style="font-weight: bold;">Home</a></li>
      ...
      <div class="app-content-header">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-9">
              <h3 class="mb-4 ">Simple Tables</h3>
            </div>
            <!--end::Row-->
          </div>
          <!--end::Container-->
        </div>
        <div class="app-content" style="padding-bottom:305px ;">
          <!--begin::Container-->
          <div class="container-fluid">
            <div class="col-md-12">
              <div class="card mb-4">
